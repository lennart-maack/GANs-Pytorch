...
def plot_hist(run_dir, nimgs=None, **kwargs):
    """
    ...
    **kwargs: See metric_utils.MetricOptions for the full list of arguments.
    ...
    plt.ylabel("Count")
    plt.savefig(os.path.join(run_dir, f'color_hist_full_.png'))
    plt.close()
    ...
    plt.xlabel("Pixel value")
    plt.ylabel("Count")
    plt.savefig(os.path.join(run_dir, f'color_hist_log_.png'))
    plt.close()
    ...
    plt.xlabel("Pixel value")
    plt.ylabel("Count")
    plt.savefig(os.path.join(run_dir, f'color_hist_wo30_.png'))
    plt.close()
